<?php
/*
Template Name: Services => Bird & Bat Strategies => without NEWS
*/
?>
				...
				<aside class="col-md-4 sidebar">
					...
					<section class="widget categories services-sidebar-box">
						...
						<!-- ################## END SIDEBAR NAV FOR AERIAL MGMNT ################## -->
							...
							<li>
								<a href="http://www.west-inc.com/services/big-game-research-monitoring/"><i class="fa fa-angle-right"></i>Big Game Research & Monitoring</a>
							</li>
