<?php
/*
Template Name: Markets International Template
*/
?>
        ...
        <div style="overflow-x: hidden;">
            ...
            <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow-x: hidden;">
                ...
                <ul class="marketsSidebar">
                 	<li class="marketsSidebarActive"><i class="fa fa-angle-right"></i>Renewable</li>
                  <ul class="marketsSidebarInner">
                   	...
                   	<li class="marketsSidebarInnerActive"><i class="fa fa-caret-right"></i><a href="http://www.west-inc.com/international">International</a></li>
                  </ul>
                 	<li><i class="fa fa-angle-right"></i><a href="http://www.west-inc.com/power-lines">Power Lines</a></li>
                 	<li><i class="fa fa-angle-right"></i><a href="http://www.west-inc.com/oil-and-gas">Oil and Gas</a></li>
