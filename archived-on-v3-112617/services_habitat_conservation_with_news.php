<?php
/*
Template Name: Services => Habitat Conservation => with NEWS
*/
?>
				...
				<aside class="col-md-4 sidebar">
					...
					<section class="widget categories services-sidebar-box">
						...
						<ul class="servicesSidebar">
							...
							<li>
								<a href="http://www.west-inc.com/bird-and-bat-conservation-strategies/"><i class="fa fa-angle-right"></i>Bird and Bat Conservation Strategies</a>
							</li>
