<?php
/*
Template Name: Services => Threatened Species => with NEWS
*/
?>
	...
	<section id="main-and-sidebar">
		<div class="container">
				...
				<aside class="col-md-4 sidebar">
					...
					<div class="taes-subtitle" style="float: left; width: 100%;">
						<h5 class="ourServicesHeader">Threatened/Endangered Species</h5>
					</div>

					<ul class="taes-nav-box" style="float: left; width: 100%;">
						<li class="">
							<a href="http://www.west-inc.com/desert-tortoise-management/"><i class="fa fa-angle-right"></i>Desert Tortoise Management</a>
						</li>

						<li>
							<a href="http://www.west-inc.com/prairie-grouse-research-management/"><i class="fa fa-angle-right"></i>Prairie Grouse Research & Management</a>
						</li>
					...
					<section class="widget categories services-sidebar-box">
						...
						<ul class="servicesSidebar">
							<li>
								<a href="http://www.west-inc.com/aerial-species-research-management/"><i class="fa fa-angle-right"></i>Aerial Species Conservation & Management</a>
							</li>
