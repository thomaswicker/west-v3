<?php
/*
Template Name: Services => Avian & Bat Protection => without NEWS
*/
?>
					...
					<section class="widget categories services-sidebar-box">
						...
						<ul class="servicesSidebar">
							...
							<li class="sidebarActive">
								<a href="http://www.west-inc.com/avian-bat-protection-plans/"><i class="fa fa-angle-right"></i>Avian & Bat Protection Plans</a>
							</li>
