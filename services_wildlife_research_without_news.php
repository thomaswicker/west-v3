<?php
/*
Template Name: Services => Wildlife Research & Monitoring => without NEWS
*/
?>
	...
	<section id="main-and-sidebar">
		<div class="container">
				...
				<aside class="col-md-4 sidebar">
					...
					<!-- ############### BEGIN SERVICE ARTICLES ############### -->


					<ul class="service-articles-sidebar-container">
						<?php

						$args = array(
							'post_type' => 'servicearticles',
							'cat' =>  $cat_id
						);
						...
						<?php if ( have_posts() ) : while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
							...
							<li>
								<a href="<?php the_field('servicearticleimg'); ?>">
									<img src="<?php the_field('servicearticleimg'); ?>" alt="<?php the_title(); ?>" />
								</a>
							</li>
