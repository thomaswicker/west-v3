<?php
/*
Template Name: Markets Pipelines Template
*/
?>
            ...
            <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow-x: hidden;">
                ...
                <ul class="marketsSidebar">
                  ...
                  <ul class="marketsSidebarInner">
                 	...
                 	<li class="marketsSidebarActive"><i class="fa fa-angle-right"></i><a href="http://www.west-inc.com/pipelines">Pipelines</a></li>
