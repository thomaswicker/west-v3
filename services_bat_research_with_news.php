<?php
/*
Template Name: Services => Bat Research => with NEWS
*/
?>
				...
				<aside class="col-md-4 sidebar">
					...
					<section class="widget categories services-sidebar-box">
						...
						<ul class="servicesSidebar">
							...
							<li>
								<a href="http://www.west-inc.com/aerial-survey-telemetry/"><i class="fa fa-angle-right"></i>Aerial Survey & Telemetrys</a>
							</li>
